...
//
////////////////////////////////////////////////////////////////////////////////
// FPU가 추가되었기 때문에 자료구조의 크기가 16의 배수로 정렬되어야 한다.
////////////////////////////////////////////////////////////////////////////////
typedef struct kTaskControlBlockStruct
{
    ...
    // 앞으로 추가할 데이터는 현재 라인 아래에 추가해야 한다.
...
![image](https://user-images.githubusercontent.com/34773827/61848465-230a4780-aee9-11e9-851a-6891637922df.png)
