# 최종 부트로더 소스 코드
 ...
 메시지 출력을 함수 형태로 바꾸고, OS 이미지를 메모리로 복사 하도록 변경
...
### PRINTMESSAGE 함수에 매개변수를 추가해 내가 원하는 색상으로 출력!

```assembly
; PARAM: x 좌표, y 좌표, 색 옵션 바이트, 문자열
PRINTMESSAGE:
	push bp
	mov bp, sp
...
[![colors](http://xlogicx.net/wp-content/uploads/2016/08/colors.png)
